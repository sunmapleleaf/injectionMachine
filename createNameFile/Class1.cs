...
using System.Threading;
    ...
    public class Telnet
    {
        ...
        public bool Connect()
        {
            DateTime beforDT = System.DateTime.Now;  //ivan test
            ...
            Console.WriteLine("conn11总共花费{0}ms.", ts.TotalMilliseconds);
            ...
            try
            {
                ...
                Console.WriteLine("conn22总共花费{0}ms.", ts.TotalMilliseconds);
                //异步回调
                ...
                s.BeginReceive(m_byBuff, 0, m_byBuff.Length, SocketFlags.None, recieveData, s);
                 ...
                 afterDT = System.DateTime.Now;
                 ts = afterDT.Subtract(beforDT);
                Console.WriteLine("conn33总共花费{0}ms.", ts.TotalMilliseconds);
                return true;
            }
            catch (Exception)
            {
